...
def neutralize(word, g, word_to_vec_map):
    ...
    #MYNOTE: e_biascomponent = np.dot(e,g) * g / np.dot(g,g) after NEU is -9.699e-17 , different expression different results
    #MYNOTE: e_biascomponent = np.dot(e,g) * g / np.power(g,2) after NEU is -0.03, different expression different results
