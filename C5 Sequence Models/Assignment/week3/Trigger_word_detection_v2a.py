...
def insert_audio_clip(background, audio_clip, previous_segments):
    ...
    while is_overlapping(segment_time, previous_segments) and retry >= 0:
        segment_time = get_random_time_segment(segment_ms) #MYNOTE: repeat step 1,get random. Not "segment_time = segment_time "!
        retry = retry - 1
    ### END CODE HERE ###
        #print(segment_time)
...
def insert_ones(y, segment_end_ms):
    ...
    if segment_end_y < Ty:
        ...
        for i in range(segment_end_y+1,segment_end_y+51):  #MYNOTE: segment_end_y=0, segment_end_y+1 = 1
            if i < Ty: #MYNOTE: make sure i not exceeds Ty,
                y[0, i] = 1
        ### END CODE HERE ###
...
your_filename = "audio_examples/myaudioa.wav"
