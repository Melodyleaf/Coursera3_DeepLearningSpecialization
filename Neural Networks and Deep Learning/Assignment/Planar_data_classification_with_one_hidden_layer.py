...
def compute_cost(A2, Y): 
    ...
    m = Y.shape[1] # number of examples  #MY NOTE: CHANGE X.SHAPE[1] TO Y.SHAPE[1]
...
def backward_propagation(parameters, cache, X, Y):
    ...
    """
    m = X.shape[1] #MY NOTE : CHANGE Y.shape[1] to X.shape[1]
...
def update_parameters(parameters, grads, learning_rate = 1.2):
    ...
    b2 = b2 - learning_rate*db2 #MY NOTE: b1=b2-learning_rate*db2 !!!!!!!
