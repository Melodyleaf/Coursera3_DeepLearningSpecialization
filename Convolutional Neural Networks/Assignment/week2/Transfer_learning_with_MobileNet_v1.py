...
def alpaca_model(image_shape=IMG_SIZE, data_augmentation=data_augmenter()):
    ...
    x =data_augmentation(inputs)  #MYNOTE:data_augmenter(inputs) wrong! data_augmenter's input is 0 in previous defination
    ...
    outputs = tfl.Dense(1)(x) #MYNOTE: prediction_layer=tfl.Dense(1),outputs=prediction_layer(x)
