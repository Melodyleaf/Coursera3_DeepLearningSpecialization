...
def random_mini_batches(X, Y, mini_batch_size = 64, seed = 0):
    ...
    if m % mini_batch_size != 0:
        ...
        # mini_batch_Y =
        # YOUR CODE STARTS HERE
        mini_batch_X = shuffled_X[:,(k+1)*mini_batch_size:] #MY NOTE
...
def initialize_velocity(parameters):
    ...
    for l in range(1, L + 1):
        ...
        # v["db" + str(l)] =
        # YOUR CODE STARTS HERE
        #v["dW" + str(l)] = np.zeros(np.shape(parameters['W' + str(l)])) #MY NOTE: OK
        #v["db" + str(l)] = np.zeros(np.shape(parameters['b' + str(l)])) #MY NOTE: OK
...
def initialize_adam(parameters) :
    ...
    # (approx. 4 lines)
        ...
        # s["db" + str(l)] = ...
    # YOUR CODE STARTS HERE
        v["dW" + str(l)] = np.zeros(parameters['W' + str(l)].shape) #MY NOTE:IndentationError:expected an indented block 
        v["db" + str(l)] = np.zeros(parameters['b' + str(l)].shape) #MY NOTE: CORRECT: for: PLUS "tab"
